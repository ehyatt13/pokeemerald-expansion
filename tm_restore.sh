...
#FIND2="TM_FLAMETHROWER"
#REPLACE2="TM_HIDDEN_POWER"
#
#for file in "${FILES2[@]}"; do
#    if [ -f "$file" ]; then
#        echo "Processing $file..."
#        sed -i "s|${FIND2}|${REPLACE2}|g" "$file"
#        echo "Restored ${FIND2} to ${REPLACE2}"
#    else
#        echo "Error: File '$file' not found. Skipping."
#    fi
#done
...
FIND3="TM_HAZE"
REPLACE3="TM_SAFEGUARD"

if [ -f "$FILE3" ]; then
    echo "Processing $FILE3..."
    sed -i "s|${FIND3}|${REPLACE3}|g" "$FILE3"
    echo "Restored ${FIND3} to ${REPLACE3}"
else
...
FIND4="TM_CURSE"
REPLACE4="TM_FRUSTRATION"

if [ -f "$FILE4" ]; then
    echo "Processing $FILE4..."
    sed -i "s|${FIND4}|${REPLACE4}|g" "$FILE4"
    echo "Restored ${FIND4} to ${REPLACE4}"
else
...
#        echo "Restored ${FIND6} to ${REPLACE6}"
#    else
#        echo "Error: File '$file' not found. Skipping."
#    fi
#done
...
FIND7="TM_AGILITY"
REPLACE7="TM_DOUBLE_TEAM"
FIND7_2="Agility"
REPLACE7_2="DoubleTeam"

for file in "${FILES7[@]}"; do
    if [ -f "$file" ]; then
        echo "Processing $file..."
        sed -i "s|${FIND7}|${REPLACE7}|g" "$file"
        echo "Restored ${FIND7} to ${REPLACE7}"
...
FIND8="TM_VOLT_SWITCH"
REPLACE8="TM_SHOCK_WAVE"
...
#        echo "Restored ${FIND10} to ${REPLACE10}"
#    else
#        echo "Error: File '$file' not found. Skipping."
#    fi
#done
...
FIND12="TM_SMART_STRIKE"
REPLACE12="TM_STEEL_WING"
FIND12_2="SMART STRIKE"
REPLACE12_2="STEEL WING"

if [ -f "$FILE12" ]; then
    echo "Processing $FILE12..."
    sed -i "s|${FIND12}|${REPLACE12}|g" "$FILE12"
    echo "Restored ${FIND12} to ${REPLACE12}"
...
echo "All restore tasks completed."
