...
const u32 gTrainerFrontPic_Birch[] = INCBIN_U32("graphics/trainers/front_pics/birch.png");
const u32 gTrainerPalette_Birch[] = INCBIN_U32("graphics/trainers/front_pics/birch.pal");
