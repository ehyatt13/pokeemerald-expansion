...
const u8 gText_PkmnBurned[] = _("{STR_VAR_1} was burned.{PAUSE_UNTIL_PRESS}");
const u8 gText_PkmnPoisoned[] = _("{STR_VAR_1} was poisoned.{PAUSE_UNTIL_PRESS}");
const u8 gText_PkmnParalyzed[] = _("{STR_VAR_1} was paralyzed.{PAUSE_UNTIL_PRESS}");
const u8 gText_PkmnFrozen[] = _("{STR_VAR_1} was frozen.{PAUSE_UNTIL_PRESS}");
const u8 gText_PkmnPutToSleep[] = _("{STR_VAR_1} was put to sleep.{PAUSE_UNTIL_PRESS}");
const u8 gText_PkmnAlreadyHasStatus[] = _("{STR_VAR_1} already has a\n status condition.{PAUSE_UNTIL_PRESS}");
const u8 gText_PkmnIsFainted[] = _("{STR_VAR_1} is fainted.{PAUSE_UNTIL_PRESS}");
const u8 gText_WhichStatus[] = _("Choose a status to give\n{STR_VAR_1}.{PAUSE_UNTIL_PRESS}");
