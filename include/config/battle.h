...
#define B_SMART_WILD_AI_FLAG        FLAG_SMART_WILD     // If this flag is set, wild Pokémon will become smart, with all AI flags enabled.
...
#define B_FLAG_TERA_ORB_CHARGED     FLAG_TERA_USABLE     // If this flag is set, the Tera Orb is charged. It is automatically set upon healing and cleared upon Terastallizing once configured.
