...
//My flags
#define AI_FLAG_GOOD_TRAINER        (AI_FLAG_BASIC_TRAINER | AI_FLAG_SMART_MON_CHOICES | AI_FLAG_SMART_TERA)
#define AI_FLAG_BOSS_TRAINER        (AI_FLAG_GOOD_TRAINER | AI_FLAG_ACE_POKEMON | AI_FLAG_PREDICTION)
